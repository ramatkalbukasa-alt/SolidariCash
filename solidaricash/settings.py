...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-solidaricash-dev-key-change-in-production')
...
ROOT_URLCONF = 'solidaricash.urls'
...
WSGI_APPLICATION = 'solidaricash.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='SolidariCash <noreply@solidaricash.com>')
...
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'http://localhost:64874',
    'http://127.0.0.1:64874',
    'http://localhost',
    'http://127.0.0.1',
]
if RENDER_EXTERNAL_HOSTNAME:
...
APP_NAME = config('APP_NAME', default='SolidariCash')
APP_CURRENCY = config('APP_CURRENCY', default='USD')
